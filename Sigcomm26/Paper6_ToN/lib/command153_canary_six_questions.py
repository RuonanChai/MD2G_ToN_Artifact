...
def render_md(body: dict) -> str:
    ...
    lines = [
        ...
        "- 主比较: MD2G vs HV3 / CLUSTERING / RULE 中最强者；**不要只看 mean U**",
        "- MOQ_UNICAST 只作交付方式诊断，不是算法赢 baseline 的主证据",
        "- pre-Rb 56 格不进入本报告",
        "",
        ...
        "",
        "## Q2  u20 vs u60（真实 Rb 下 high-concurrency crossover）",
        "",
