#!/usr/bin/env python3
"""Diagnostic V4 contact sheet: each page is the figure at native paper size."""
...
OUT = FIG / "FIGURE_VISUAL_REDESIGN_V4_CONTACT_SHEET.pdf"
...
def main() -> int:
    writer = PdfWriter()
    print("V4 contact sheet (native page sizes)")
    for rel in FILES:
        path = FIG / rel
        if not path.is_file():
